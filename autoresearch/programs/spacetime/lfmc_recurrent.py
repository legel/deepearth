...
from deepearth.autoresearch.programs.spacetime.science_gate import (
    DEFAULT_DATA_PATH,
    DEFAULT_TRAIN_END,
...
def main(argv=None):
    ...
    ap.add_argument("--ledger", type=Path, default=Path("data/lfmc/earth4d_recurrent_ledger.jsonl"))
    ap.add_argument("--json-out", type=Path, default=Path("data/lfmc/earth4d_recurrent.json"))
