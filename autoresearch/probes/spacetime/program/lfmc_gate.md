...
> **`autoresearch/probes/spacetime/program/program.md`** — objective, lever families, diagnosis, experiment tracking. This file
...
| question | file |
|---|---|
| what do I run, and how do I pick a capability? | `autoresearch/probes/spacetime/program/program.md` |
| what is the board, and what is excluded? | `autoresearch/probes/spacetime/program/scorecard.md` |
| which probe modes move my capability, and where do I edit? | `probe_registry.py` (`--capability X`) |
| what must a result satisfy before it is science? | `autoresearch/probes/spacetime/program/program.md`, "Evidence standard" |
