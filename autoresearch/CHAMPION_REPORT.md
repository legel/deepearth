...
|---|---:|---:|---:|---:|
| Fresh v2 control | 1337 | 0.418762 | 0.581057 | 0.172044 |
| Fresh v2 control | 1338 | 0.419921 | 0.584020 | 0.174569 |
| **Fresh v2 baseline** | **2 seeds** | **0.419341** | **0.582539** | **0.173307** |
...
Evaluation now follows its zero-noise central path; training behavior is unchanged. Replaying seed 1337 before the fix
produced harmonic values from `0.417799` to `0.420934`; the corrected model removes that explicit inference RNG.
