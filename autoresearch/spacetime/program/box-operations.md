...
- Run one deliberate swing at a time:
  `cd /workspace/deepearth && PYTHONPATH=/workspace python3.12 -m deepearth.autoresearch.spacetime.editable_files.harness --metric <cap> --probe "<flags>" --tag <id> --device cuda:N --ensue`
