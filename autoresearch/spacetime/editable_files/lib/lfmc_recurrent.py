...
def main(argv=None):
    ...
    ap.add_argument("--ledger", type=Path, default=Path("autoresearch/spacetime/editable_files/data/lfmc/earth4d_recurrent_ledger.jsonl"))
    ap.add_argument("--json-out", type=Path, default=Path("autoresearch/spacetime/editable_files/data/lfmc/earth4d_recurrent.json"))
