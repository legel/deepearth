...
Usage on newbox (real Earth4D held-out logits, reuses probe.py loaders + head):
  CUDA_VISIBLE_DEVICES=0 python -m deepearth.autoresearch.spacetime.editable_files.lib.calib_probe \
...
"""
_MODULE_NAME = "deepearth.autoresearch.spacetime.editable_files.lib.calib_probe"
...
def _real_features(cache, feature, n_shards, dev, seed):
    ...
    from deepearth.autoresearch.spacetime.editable_files.harness import probe as P
