...
if __name__ == "__main__":
    ...
    from deepearth.autoresearch.spacetime.editable_files.lib.recurrence import (
...
def main(argv=None):
    ...
    if a.env_decode:
        ...
        from deepearth.autoresearch.spacetime.editable_files.lib.env_field import run_env_decode
        with torch.no_grad():
    ...
    if a.field_decode:
        ...
        from deepearth.autoresearch.spacetime.editable_files.lib.recurrence import run_field_decode
        with torch.no_grad():
            fdim = enc(coords[:8].to(dev)).shape[1]
    ...
    if a.phenology:
        ...
        from deepearth.autoresearch.spacetime.editable_files.lib.phenology import run_phenology_all
    ...
    if a.gnn:
        ...
        from deepearth.autoresearch.spacetime.editable_files.lib.gnn import run_gnn
        coords_ll = torch.tensor(np.stack([lat, lon], 1).astype(np.float32))
    ...
    if a.recurrence:
        ...
        if a.rec_time_cond:
            ...
            from deepearth.autoresearch.spacetime.editable_files.lib.recurrence import run_recurrence_timecond
            def _tn(day_arr):
        ...
        from deepearth.autoresearch.spacetime.editable_files.lib.recurrence import run_recurrence
