...
Usage:
    python -m deepearth.autoresearch.spacetime.harness.probe_registry --capability family_from_env
    python -m deepearth.autoresearch.spacetime.harness.probe_registry --all
"""
