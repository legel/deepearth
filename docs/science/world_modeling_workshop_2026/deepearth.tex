...
\outline{context on what is world modeling}
\outline{context on why you may want to use world modeling for ecology}
\outline{review on types of world models}
\outline{reference multi-modal world models}
\outline{context on what is a neural field}
\outline{connection on neural field for world modeling}
\outline{context of Galileo, since used later in the paper}
\outline{we present DeepEarth... Why coordinates and species alone?}
