...
Run this from the root directory of the deepearth project.
"""

import sys
import os

# Add the parent directory to Python path so we can import deepearth
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

import torch

# Now import from the models directory directly
from models.configs import DeepEarthConfig, ModalityConfig, TransformerConfig
from models.hash_encoding import MultiResolutionHashEncoding
