...
_Scene `20241209_162245_09_24dc` · generated 2026-06-26 00:55 UTC by `visualize_psscene.py`_
...
| Property | Value |
|---|---|
| Item ID | `20241209_162245_09_24dc` |
| Instrument / satellite | PSB.SD / 24dc |
| Acquired (UTC) | 2024-12-09T16:22:45.099764Z |
...
| Sun elev / azim | 36.5° / 163.7° |
| View angle | 8.3° |
| Cloud / clear | 0% / 100% |
| Quality category | standard |
| UDM2 clear (in-footprint) | 100.0% |
| UDM2 mean confidence | 97.3% |
| Open water (sub-pixel) | 5.1% (20.5 ha; 223 bodies) |

## 2. Original data & paths

| Role | File |
|---|---|
| Surface-reflectance cube (8-band) | `PSScene/20241209_162245_09_24dc_3B_AnalyticMS_SR_8b_clip.tif` |
| UDM2 quality mask (8-band) | `PSScene/20241209_162245_09_24dc_3B_udm2_clip.tif` |
| Band radiometry XML | `PSScene/20241209_162245_09_24dc_3B_AnalyticMS_8b_metadata_clip.xml` |
| Item metadata (STAC props) | `PSScene/20241209_162245_09_24dc_metadata.json` |
...
|---|---|---|---|---|
| 1 | Coastal Blue | 443 | `cividis` | 0.008 – 0.131 |
| 2 | Blue | 490 | `gray` | 0.012 – 0.147 |
| 3 | Green I | 531 | `gray` | 0.020 – 0.168 |
| 4 | Green | 565 | `gray` | 0.027 – 0.189 |
| 5 | Yellow | 610 | `gray` | 0.022 – 0.205 |
| 6 | Red | 665 | `gray` | 0.020 – 0.208 |
| 7 | Red Edge | 705 | `magma` | 0.020 – 0.221 |
| 8 | NIR | 865 | `inferno` | 0.034 – 0.330 |
...
|---|---|---|
| 1 | 2.69293086032968e-05 | 0.01 |
| 2 | 2.6007275933998683e-05 | 0.01 |
| 3 | 2.7795771746787343e-05 | 0.01 |
| 4 | 2.8206910712928722e-05 | 0.01 |
| 5 | 3.031580646028173e-05 | 0.01 |
| 6 | 3.395091132459579e-05 | 0.01 |
| 7 | 3.629562390908285e-05 | 0.01 |
| 8 | 5.37357560653859e-05 | 0.01 |
...
| `derived/ndvi.png / ndvi_annotated.png` | NDVI = (NIR-Red)/(NIR+Red) (vegetation vigour / greenness); range [-1,1], `RdYlGn`. Scene median +0.513. |
| `derived/ndre.png / ndre_annotated.png` | NDRE = (NIR-RedEdge)/(NIR+RedEdge) (canopy chlorophyll / N status); range [-1,1], `RdYlGn`. Scene median +0.371. |
| `derived/ndwi.png / ndwi_annotated.png` | NDWI = (Green-NIR)/(Green+NIR) (open water (McFeeters)); range [-1,1], `RdBu`. Scene median -0.529. |
| `derived/ndwire.png / ndwire_annotated.png` | NDWIre = (RedEdge-NIR)/(RedEdge+NIR) (red-edge water variant; separates dark water from shadow/wet vegetation); range [-1,1], `RdBu`. Scene median -0.371. |
...
- **RGB / false-colour exposure:** independent per-channel percentile stretch at **2–98%** of valid pixels (a gray-world white balance), then **gamma 1.8**. Per-channel reflectance windows used: Red 0.020–0.208, Green 0.027–0.189, Blue 0.012–0.147.
...
```bash
python visualize_psscene.py Florida_Hydrology_Min_Precipitation_2 \
...
python visualize_psscene.py Florida_Hydrology_Min_Precipitation_2 --s2-fusion
```
