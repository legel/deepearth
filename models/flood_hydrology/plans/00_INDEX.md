...
| F | `track_F_repo_hygiene.md` | README refresh, commit backlog, .gitignore | none | **Done 2026-06-18** — README rescoped, .gitignore finished, WIP committed in 8 logical chunks |
