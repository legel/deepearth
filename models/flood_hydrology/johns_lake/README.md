# johns_lake — Johns Lake, Winter Garden FL

One of two sites under [`../`](../README.md). Shared method lives in `../floodtwin/`;
the sibling gauge-validated twin is [`../cfx_sr417/`](../cfx_sr417/README.md).
