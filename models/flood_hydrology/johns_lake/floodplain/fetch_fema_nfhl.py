"""
FEMA National Flood Hazard Layer (NFHL) — Flood Zones & Floodway for the Johns Lake AOI
===============================================================================================
Pulls FEMA NFHL flood hazard zone polygons intersecting the 2x2 km Johns Lake AOI around
28.521592N, -81.656981W (Winter Garden, FL), via the public NFHL ArcGIS REST MapServer, and
flags which (if any) are the regulatory floodway. Ported from the sibling cfx_sr417_corridor
project 2026-07-28 (same script, different AOI) — Johns Lake had no FEMA layer at all before
this.
...
NAVD88) — compare directly against dem/data/winter_garden_dem_meta.json's
...
Usage:
    ...
    python3 floodplain/fetch_fema_nfhl.py --lat 28.521592 --lon -81.656981 --radius_km 1.0
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fetch FEMA NFHL flood hazard zones for the Johns Lake AOI")
