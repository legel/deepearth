...
_Scene `20230917_151646_54_24a9` · generated 2026-06-26 00:46 UTC by `visualize_psscene.py`_
...
| Property | Value |
|---|---|
| Item ID | `20230917_151646_54_24a9` |
| Instrument / satellite | PSB.SD / 24a9 |
| Acquired (UTC) | 2023-09-17T15:16:46.549011Z |
...
| Sun elev / azim | 50.2° / 125.5° |
| View angle | 5.1° |
| Cloud / clear | 11% / 76% |
| Quality category | standard |
| UDM2 clear (in-footprint) | 76.2% |
| UDM2 mean confidence | 85.3% |
| Open water (sub-pixel) | 6.4% (25.8 ha; 199 bodies) |

## 2. Original data & paths

| Role | File |
|---|---|
| Surface-reflectance cube (8-band) | `PSScene/20230917_151646_54_24a9_3B_AnalyticMS_SR_8b_clip.tif` |
| UDM2 quality mask (8-band) | `PSScene/20230917_151646_54_24a9_3B_udm2_clip.tif` |
| Band radiometry XML | `PSScene/20230917_151646_54_24a9_3B_AnalyticMS_8b_metadata_clip.xml` |
| Item metadata (STAC props) | `PSScene/20230917_151646_54_24a9_metadata.json` |
...
|---|---|---|---|---|
| 1 | Coastal Blue | 443 | `cividis` | 0.023 – 0.289 |
| 2 | Blue | 490 | `gray` | 0.020 – 0.291 |
| 3 | Green I | 531 | `gray` | 0.023 – 0.310 |
| 4 | Green | 565 | `gray` | 0.027 – 0.332 |
| 5 | Yellow | 610 | `gray` | 0.027 – 0.360 |
| 6 | Red | 665 | `gray` | 0.020 – 0.344 |
| 7 | Red Edge | 705 | `magma` | 0.028 – 0.367 |
| 8 | NIR | 865 | `inferno` | 0.050 – 0.498 |
...
|---|---|---|
| 1 | 2.1737215046016722e-05 | 0.01 |
| 2 | 2.0992954481914e-05 | 0.01 |
| 3 | 2.2436620142410307e-05 | 0.01 |
| 4 | 2.2768489640155904e-05 | 0.01 |
| 5 | 2.447078066608408e-05 | 0.01 |
| 6 | 2.740502072825717e-05 | 0.01 |
| 7 | 2.9297662029261727e-05 | 0.01 |
| 8 | 4.3375257139375314e-05 | 0.01 |
...
| `derived/ndvi.png / ndvi_annotated.png` | NDVI = (NIR-Red)/(NIR+Red) (vegetation vigour / greenness); range [-1,1], `RdYlGn`. Scene median +0.524. |
| `derived/ndre.png / ndre_annotated.png` | NDRE = (NIR-RedEdge)/(NIR+RedEdge) (canopy chlorophyll / N status); range [-1,1], `RdYlGn`. Scene median +0.401. |
| `derived/ndwi.png / ndwi_annotated.png` | NDWI = (Green-NIR)/(Green+NIR) (open water (McFeeters)); range [-1,1], `RdBu`. Scene median -0.481. |
| `derived/ndwire.png / ndwire_annotated.png` | NDWIre = (RedEdge-NIR)/(RedEdge+NIR) (red-edge water variant; separates dark water from shadow/wet vegetation); range [-1,1], `RdBu`. Scene median -0.401. |
...
- **RGB / false-colour exposure:** independent per-channel percentile stretch at **2–98%** of valid pixels (a gray-world white balance), then **gamma 1.8**. Per-channel reflectance windows used: Red 0.020–0.344, Green 0.027–0.332, Blue 0.020–0.291.
...
```bash
python visualize_psscene.py Florida_Hydrology_Avg_Precipitation_2 \
...
python visualize_psscene.py Florida_Hydrology_Avg_Precipitation_2 --s2-fusion
```
