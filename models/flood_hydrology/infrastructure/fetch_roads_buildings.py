#!/usr/bin/env python3
"""
Fetch roads and building footprints for the Johns Lake AOI.

Ported from the sibling cfx_sr417_corridor project 2026-07-28 (same script, different AOI —
28.521592N, -81.656981W, Winter Garden, FL) — Johns Lake had no roads/buildings layer at all
before this. Roads/buildings become the geometric mask for separating built surfaces from
natural ground in later analysis.
...
Usage:
    ...
    python3 infrastructure/fetch_roads_buildings.py --lat 28.521592 --lon -81.656981 --radius_km 1.0
