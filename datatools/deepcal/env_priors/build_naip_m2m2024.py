    ...
    if SAVE_PATCH32:
        ...
        with open(PATCH / "metadata.json", "w") as f:
            json.dump({
                ...
                "patch_elev": "optional chunk*.npz:patch_elev [N,32,32] when a DEM-aligned elevation raster is generated",
                "center_elev_m": "manifest.npz:elev_m, copied from gbif_elev.npz when present and used as the patch_elev fallback",
